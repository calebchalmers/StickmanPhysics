...
public class CameraBounds : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        topCollider = Instantiate(wallPrefab).transform;
        bottomCollider = Instantiate(wallPrefab).transform;
        rightCollider = Instantiate(wallPrefab).transform;
        leftCollider = Instantiate(wallPrefab).transform;
        ...
        screenSize.x = Vector2.Distance(Camera.main.ScreenToWorldPoint(new Vector2(0, 0)), Camera.main.ScreenToWorldPoint(new Vector2(Screen.width, 0))) * 0.5f - 0.25f;
        screenSize.y = Vector2.Distance(Camera.main.ScreenToWorldPoint(new Vector2(0, 0)), Camera.main.ScreenToWorldPoint(new Vector2(0, Screen.height))) * 0.5f - 0.25f;
        ...
        topCollider.localScale = new Vector3(screenSize.x * 2 + colDepth * 2, colDepth, colDepth);
        topCollider.position = new Vector3(cameraPos.x, cameraPos.y + screenSize.y + (topCollider.localScale.y * 0.5f), zPosition);
        bottomCollider.localScale = new Vector3(screenSize.x * 2 + colDepth * 2, colDepth, colDepth);
